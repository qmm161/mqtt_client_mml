...
class MqttCli(Cmd) :
    ...
    subparser.add_argument('-q', '--qos', choices=[0,1,2], default=0, help='qos')
    ...
    pubparser.add_argument('-q', '--qos', choices=[0,1,2], default=0, help='qos')
    pubparser.add_argument('-r', '--retain', type=bool, default=False, help='is need retain')

    @with_argparser(pubparser)
    def do_pub(self, args) :
        print('publish topic: ' + args.topic + ' msg: ' + args.json + ' with qos: ' + str(args.qos))
